...
def page_insights():
    ...
    if soc:
        ...
        fig1.update_layout(
            ...
            xaxis=dict(title='Score out of 10', range=[0, 14],
    ...
    if cult_show:
        ...
        fig3.add_trace(go.Bar(
            y=c_labels, x=c_scores, orientation='h',
            marker_color=c_colors,
            text=c_labels_dual, textposition='outside',
            textfont=dict(size=11, color='#1e293b'),
            cliponaxis=False,
        ))
        fig3.add_vline(x=cult_avg, line_dash='dot', line_color='#f59e0b', line_width=2,
                       annotation_text=f'Avg {cult_avg}', annotation_position='top',
                       annotation_font=dict(size=11, color='#92400e'))
